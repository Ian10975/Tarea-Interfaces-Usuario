...
```
cd existing_repo
git remote add origin https://gitlab.com/bioscanner/inference-demo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/bioscanner/inference-demo/-/settings/integrations)
